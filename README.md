...
## Your team's combination: French restaurants in Mumbai

Your team has been tasked with using the Zomato API to list French restaurants in Mumbai in the style of the Foodora site:
